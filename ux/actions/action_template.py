...
class ActionTemplate(object):
    ...
    def __init__(self,
        ...
        :param source_id: The id of the Location where the Action would be taken
                          (used in matching).
        :param target_id: Optional id of the Location where the Action would go
                          to (used in matching).
        :param weighting: Optional weighting value to use in various
                          calculations.
        """
    ...
    def reversed(self, action_type: str = None) -> 'ActionTemplate':
        ...
        :param action_type: Optional action type. Leave as None to use the
    ...
    def __eq__(self, other: 'ActionTemplate') -> bool:
        return (
                (self._action_type == other._action_type or
                 '*' in (self._action_type, other._action_type)) and
                (self._source_id == other._source_id or
                 '*' in (self._source_id, other._source_id)) and
                (self._target_id == other._target_id or
                 '*' in (self._target_id, other._target_id))
        )
